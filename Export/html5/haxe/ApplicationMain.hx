...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("BouncingBall", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("BouncingBall", null, 0, 0);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["file"] = "BouncingBall";
		app.meta["name"] = "BouncingBall";
		app.meta["packageName"] = "com.sample.bouncingball";
